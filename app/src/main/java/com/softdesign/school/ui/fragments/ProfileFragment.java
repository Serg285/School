...
public class ProfileFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((MainActivity)getActivity()).mNavigationView.getMenu().findItem(R.id.drawer_profile).setChecked(true);

        ((MainActivity)getActivity()).mCollapsingToolbar.setTitle(getResources().getString(R.string.user_name));
