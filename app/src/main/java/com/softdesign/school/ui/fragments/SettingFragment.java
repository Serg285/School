...
public class SettingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((MainActivity)getActivity()).mNavigationView.getMenu().findItem(R.id.drawer_task).setChecked(false);
        ((MainActivity)getActivity()).mNavigationView.getMenu().findItem(R.id.drawer_team).setChecked(false);
        ((MainActivity)getActivity()).mNavigationView.getMenu().findItem(R.id.drawer_setting).setChecked(true);

        ((MainActivity)getActivity()).mCollapsingToolbar.setTitle(getResources().getString(R.string.drawer_setting));
