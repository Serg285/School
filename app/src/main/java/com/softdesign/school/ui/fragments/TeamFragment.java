...
public class TeamFragment extends Fragment {
    ...
    getActivity().setTitle(getResources().getString(R.string.drawer_team));
        ...
        ((MainActivity)getActivity()).mNavigationView.getMenu().findItem(R.id.drawer_team).setChecked(true);
        ((MainActivity)getActivity()).mCollapsingToolbar.setTitle(getResources().getString(R.string.drawer_team));
